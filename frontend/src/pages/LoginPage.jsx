	...
	const handleSubmit = async (e) => {
		...
		axios
			...
			.then((result) => {
				...
				if (!accessToken) throw new Error("Token is NULL");
			...
			.catch((error) => {
				setLoginError(
					"Invalid email or password. Please try again or try signing in using other methods"
				);
				...
				<form className="login-form" onSubmit={handleSubmit}>
					...
					<button type="submit" className="login-button" disabled={isLoading}>
						{isLoading ? (
							...
							"Sign up to NoteShare"
						) : (
							"Sign in to NoteShare"
						)}
					</button>
				</form>
